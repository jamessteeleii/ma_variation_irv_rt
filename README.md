# Little evidence for meaningful intervention effect heterogeneity in resistance training: Evidence from causal inference and meta-analytic variance comparisons
